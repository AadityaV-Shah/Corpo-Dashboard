...
const Footer = () => {
    return (
        <Box w="full" bg="rgb(225, 226, 239)" borderTop={"1px solid grey"}>
            ...
            {/* LG SIZE */}
            <Container px={8} py={6} display={{base:'none', lg:'flex'}} justifyContent="space-between">
                <Box>
            ...
            {/* LG SIZE */}
            <Container px={8} py={6} display={{base:'flex', lg:'none'}} flexDirection={'column'} justifyContent={'center'} alignItems={'center'} gap={3} >
                <Box>
                    <Text textAlign="center" fontSize="sm" color="#000000">
                        © {new Date().getFullYear()} TradeMasterPro. All rights reserved.
                    </Text>
