...
const Herobust = () => {
    return (
        <Box mt="5" gap="5" h={{ base: 'auto'}} display={"flex"} flexDirection={{base:'column', lg:'row'}} justifyContent={{ base: "center", lg: "space-between" }}>
            ...
            <Box w={{ base: '100%', sm:'100%', md:'100%', lg: '50%' }} gap={1} h="300px" px="5" display="flex" py="5" bg="white" color="Black" borderRadius="xl" justifyContent="space-between" alignItems="top" justifyItems="center">
                <Stack>
